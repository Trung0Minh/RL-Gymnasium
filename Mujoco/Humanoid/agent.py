...
class PPOAgent:
    def __init__(self, num_inputs, num_actions, device, lr=3e-4, gamma=0.99, gae_lambda=0.95, clip_coef=0.2, ent_coef=0.0, vf_coef=0.5, max_grad_norm=0.5, hidden_dim=512):
        self.device = device
