...
def train(cfg: QConfig):
    env = gym.make(cfg.env_id, is_slippery=cfg.is_slippery, map_name=cfg.map_name)
    ...
    rewards = []
    rewards_window = deque(maxlen=1000)
...
if __name__ == "__main__":
    ...
    plt.title('DQN Training Rewards for Frozen Lake')
