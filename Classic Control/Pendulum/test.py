...
def test_ddpg(n_episodes=5, checkpoint_actor='checkpoint_actor.pth', seed=2):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--checkpoint', type=str, default='checkpoint_actor.pth', help='Path to actor checkpoint')
