...
def train(env, agent, n_episodes=500, max_t=200, print_every=100, resume=False):
    """
    Standardized Training Loop for Pendulum (DDPG).
    """
    ...
    for i_episode in range(1, n_episodes + 1):
        ...
        for t in range(max_t):
            ...
            # Rescale action from [-1, 1] to [-2, 2] for Pendulum-v1
            rescaled_action = action * 2.0
            
            next_state, reward, terminated, truncated, info = env.step(rescaled_action)
