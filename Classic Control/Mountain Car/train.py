...
def train(env, agent, n_episodes=4000, max_t=1000, print_every=100, 
          eps_start=1.0, eps_end=0.01, eps_decay=0.999, resume=False):
    """
    Standardized Training Loop for Mountain Car (DQN).
    """
